...
export class SpotifyService {
  ...
  getClientCredentialsAccessToken(): Observable<ISpotifyAccessToken> {
    return this.http
      .get<ISpotifyAccessToken>(this._clientCredentialsAccessTokenUrl)
      .pipe(
  ...
  getArtists(artistSearchTerm: string): Observable<IArtist[]> {
    ...
    const httpHeaders = new HttpHeaders().set(
      "Authorization",
      "Bearer " + this._spotifyAccessToken.access_token
    );
    const httpOptions = {
      headers: httpHeaders,
      params: httpParams,
    ...
    return this.http
      .get<ISearchedArtists>(this._spotifySearchUrl, httpOptions)
      .pipe(
  ...
  getRelatedArtists(artistId: string): Observable<IArtist[]> {
    ...
    const getRelatedArtistsUrl = this._spotifyRelatedArtistsUrl.replace(
      "{id}",
      artistId
    );
    const httpHeaders = new HttpHeaders().set(
    ...
    return this.http
      .get<IRelatedArtists>(getRelatedArtistsUrl, httpOptions)
      .pipe(
