...
export class SpotifyService {
    authenticateUrl: 'https://accounts.spotify.com/api/token';
    ...
    authenticate(clientId: string, clientSecret: string): Observable<ISpotifyAccessToken> {
        ...
        const encodedClientValue = btoa(clientId + ':' + clientSecret);
        ...
        /* return this._httpClient.post<ISpotifyAccessToken>('https://accounts.spotify.com/api/token',
         body, {headers: headers, params: httpParams}).pipe(
            tap(data => console.log('Tapped Data: ' + JSON.stringify(data))),
            catchError(this.handleError)
        ); */

        return this._httpClient.post<ISpotifyAccessToken>('https://accounts.spotify.com/api/token',
        httpParams, {headers: headers}).pipe(
            tap(data => console.log('Tapped Data: ' + JSON.stringify(data))),
            catchError(this.handleError)
        );
